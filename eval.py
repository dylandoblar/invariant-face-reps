...
def run_rot_data_exp(repr_type, template_dir, test_dir, logging_dir, vgg_model_type=None, num_ids=50, num_per_id=15, num_pca_dim=50,sample_complexity_exp=False):
    #random.seed(7)

    if sample_complexity_exp:
        logging_dir = f'{logging_dir}/sample_complexity'
...
if __name__ == '__main__':
    ...
    rot_data_dir = f'/Users/kcollins/invariant_face_data/rot_data/'
    main_logging_dir = f'./rot_logging_dir/'
